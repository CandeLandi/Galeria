...
contenedorCategorias.addEventListener('click', (e) => {
    ...
    if (e.target.closest('a')) {
        ...
        //hacemos una variable que guarde la informacion del click para luego mostrar solo la data de la seccion elegido*/
...
const carousel = (direccion) => {
	...
	const observer = new IntersectionObserver((entradas) => {
		...
		galeria$2.querySelectorAll('.galeria__carousel-slide').forEach((slide) => {
